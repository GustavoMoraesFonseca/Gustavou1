...
public class DozerConverterTest {
    ...
    public void parseVOToEntityTest() {
        PersonModel output = DozerConverter.parseObject(inputObject.mockVO(), PersonModel.class);
    ...
    public void parserVOListToEntityListTest() {
        List<PersonModel> outputList = DozerConverter.parseListObjects(inputObject.mockVOList(), PersonModel.class);
